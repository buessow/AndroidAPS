...
class OverviewDataImpl @Inject constructor(
    ...
    override fun reset() {
        ...
        mlPredictionGraphSeries = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
    ...
    */
    ...
    override var mlPredictionGraphSeries: SeriesData = PointsWithLabelGraphSeries<DataPointWithLabelInterface>()
