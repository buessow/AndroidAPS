...
class StoreDataForDbImpl @Inject constructor(
    ...
    private val heartRates: MutableList<HR> = mutableListOf()
    ...
    @VisibleForTesting val nsIdHeartRates: MutableList<HR> = mutableListOf()
