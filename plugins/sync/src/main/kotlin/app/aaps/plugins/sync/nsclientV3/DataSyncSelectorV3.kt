...
class DataSyncSelectorV3 @Inject constructor(
    ...
    private suspend fun updateOneHeartRate(id: Long, lastId: Long, nsClient: NsClient): Long? {
        ...
        val (new, old) = persistenceLayer
            .getNextSyncElementHeartRate(id).blockingGet() ?: return null

        val success = if (new.ids.nightscoutId == null) {
    ...
    suspend fun processChangedHeartRate() {
        ...
        val lastDbId = persistenceLayer.getLastHeartRateId() ?: return
